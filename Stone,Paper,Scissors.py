...
mesgdcrt.GeneralMessage("Welecome to the Stone/Paper/Scissors game.\n")
Points = [0,0] 
Moves = ["Stone","Paper","Scissors"]
mesgdcrt.GeneralMessage("Rule :  One who wins the 3 match first will won the match!\n ")
while 1:
    try:
...
print()
mesgdcrt.GeneralMessage(f'User Points: {Points[0]}\nComputer Points: {Points[1]}\n')
